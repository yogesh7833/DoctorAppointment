...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
        <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border text-[#5E5E5E] text-sm shadow-lg'>
            ...
            {
                state==='Admin' ? <p>Doctor Login ?<span className='text-primary cursor-pointer underline' onClick={()=>setState('Doctor')}>Click here</span></p>:
