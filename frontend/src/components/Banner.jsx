  ...
  return (
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
        ...
        <div className='flex-1 py-8 sm:py-10 md:py-16 lg:pl-5'>
            ...
            <button onClick={()=>{navigate('/login');scrollTo(0,0)}} className='bg-white text-sm sm:text-base text-gray-800 px-8 py-3 rounded-full mt-6 hover:scale-105 transition-all duration-500'>create account</button>
        </div>
